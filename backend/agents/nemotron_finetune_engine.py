"""
PrismAI Nemotron-3 Ultra 550B Fine-Tuning & Deployment Engine
==============================================================
...
#SBATCH --job-name=prismai_nemotron_550b_peft
...
# --- PrismAI Sovereign Credentials ---
export HF_TOKEN="{hf_token}"
export HF_HOME=/shared/hf_cache
export WANDB_API_KEY="{wandb_key}"
export CONT="{NEMO_AUTOMODEL_CONTAINER}"
export CONT_NAME="nemo-automodel-prismai"
...
echo "==> [PrismAI] Launching Nemotron-3 Ultra 550B Fine-Tuning Job $SLURM_JOB_ID on $SLURM_JOB_NODELIST"
...
def inject_nemotron_550b_prompt(system_prompt: str) -> str:
    ...
    """
    prompt_addon = "\n\n[👑 PRISMAI NEMOTRON-3 ULTRA 550B FINE-TUNED SOVEREIGN CORE]:\n"
